...
def return_tables(mission_slctd):
    ...
    return return_tables(df_eda.round(2)), return_tables(df_rad.round(2)), return_tables(df_sum.round(2)), milestone_description, data_status
